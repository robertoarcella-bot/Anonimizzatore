        ...
        <div className="flex items-center justify-between max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-navy-400 hover:text-navy-100 hover:bg-navy-800/60 transition-colors"
              title="Impostazioni"
            ...
            <span className="text-xs text-navy-500 font-mono">v1.5.0</span>
          </div>
        </div>
      </header>
